...
<div class="row">
	<div class="col-sm-12">
		<div style="text-align: center;">
			<h3 style="color: red;">Đơn hàng của quý khách đã được đặt <b>THÀNH CÔNG</b>, cảm ơn quý khách!</h3>
			<i>Quý khách sẽ sớm nhậm được cuộc gọi xác nhận của chúng tôi và quí khách sẽ được thanh toán sau khi nhận hàng!</i>
