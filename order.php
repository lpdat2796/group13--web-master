				...
				<table class="table table-hover">
					...
					<tbody>
						...
						<tr>
							...
							?>
							<tr style="color: red; font-size: 18px;"><th colspan="2">Tổng tiền</th><th id="tong_tien"></th><th>VND</th></tr>
						</tbody>
					</table>
					...
					<button onclick="check_before_submit()" class="btn btn-primary" type="submit">Mua Hàng</button><br><br>
				</form>
			</div>
		</div>
	</div>
