<footer>
    <div class="container-fluid">
      <div class="row">
        <div class="col-lg-4 contact-footer" id="contact">
          <h3>Contact Us </h3>
          ...
          <i class="glyphicon glyphicon-envelope"></i><span> nakoshop@gmail.com</span><br>
          <h4 style="line-height: 26px;color:yellow">Nhận email thông báo của chúng tôi khi có sản phẩm mới hay giảm giá:</h4>
        ...
        <div class="col-lg-12" id="copyright-txt">
          <b>All right reverse, &#169; copyright of Nakoshop.com</b>
        </div>
      </div>
    </div>
  </footer>
  <div class="goTop">
    <a href="#header">
      <h5 style="color: white" title="Back to Top" class="glyphicon glyphicon-menu-up"></h5>
    </a>
  </div>
  </body>
</html>